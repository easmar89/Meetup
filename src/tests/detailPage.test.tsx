...
describe('DetailPage component', () => {
  ...
  it('renders detail without errors', () => {
    const testData: EventActivity = { id: 1, title: 'Yoga', description: 'This is a yoga group', imgUrl: '', date: '', location: '' }
    render(<DetailPage activity={testData} />)
  })

  it('renders activity title, location, description and date', () => {
    const testData: EventActivity = { id: 234, title: 'Running', description: 'Running together is fun', imgUrl: '', date: '', location: '' }
    render(<DetailPage activity={testData} />)
  ...
  it('displays place remain', () => {
    const testData: EventActivity = { id: 7, title: '', description: '', imgUrl: '', date: '', location: ''  }
  ...
  it('shows correct number on place remain after register button clicked', () => {
    const testData: EventActivity = { id: 9, title: '', description: '', imgUrl: '', date: '', location: ''  }
